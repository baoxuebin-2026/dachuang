...
12. 阶段 8 前置诊断：项目组选择 B，已形成[申报目标和拟部署架构逐项核对及视觉验证备选](docs/stage8-scope-and-evidence-options.md)。气体来源与仿真人员数据保持分离。项目组选择 V1 后完成[公开 RGB-D 人员数据候选调查](docs/stage8-v1-rgbd-source-audit.md)，随后选定 A，提交[来源取得门槛与视觉实验协议](docs/stage8-v1a-visual-source-gate-and-protocol.md)。LIRIS 原始序列当前尚未下载成功；未产出视觉成绩，等待数据取得及协议决策。
