...
7. 阶段 5 独立辅助研究：项目组选定先调查 UCI 487；已完成 [只读诊断及跨日验证方案](docs/stage5-uci487-data-and-validation-plan.md)。13 日各 100 个 CO 暴露段的**段位顺序完全重复**，单纯按日期留出仍会被程序时间泄漏。等待选择 V1／V2／V3，尚未训练 487 模型。
