...
初核日期：2026-09-24；E1 增补核查：2026-09-25。UCI 309、322、487 的压缩包已实际下载、完成 ZIP 完整性检查并记录 SHA-256；TADI 与 SB112 的公开原文件现已下载并核对发布的 MD5，结果见 [E1 源核查](../docs/stage7-e1-external-data-audit.md)；未注明者仍仅核查公开页面。本表不是焦化园区现场数据清单。
